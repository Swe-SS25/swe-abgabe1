...
--        chown postgres:postgres /var/lib/postgresql/tablespace/supplement 
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-supplement.sql
--        psql --dbname=supplement --username=supplement --file=/sql/create-schema-supplement.sql
--        exit
--      docker compose down
